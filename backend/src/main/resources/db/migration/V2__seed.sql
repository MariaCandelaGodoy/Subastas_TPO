...
(32, 'Argentina', 'AR', 'Buenos Aires', 'argentina', 'espaÃ±ol'),
(840, 'Estados Unidos', 'US', 'Washington D. C.', 'estadounidense', 'inglÃ©s'),
(858, 'Uruguay', 'UY', 'Montevideo', 'uruguaya', 'espaÃ±ol');
...
(2, 'SUB-001', 'MartÃ­n Ledesma', 'Av. Santa Fe 1400', 'activo'),
(3, '30999888', 'Nombre Apellido', 'Calle Legal 123', 'activo'),
(4, '27888111', 'JoyerÃ­a Ruiz', 'Talcahuano 450', 'activo'),
...
(1, 'VerificaciÃ³n y catÃ¡logo', 'VER', 1);
...
('POL-AR-1001', 'RÃ­o Seguros', 'si', 150000.00),
...
(1, CURDATE(), '09:45:00', 'abierta', 2, 'BÃ³veda Norte, CABA', 120, 'si', 'si', 'plata'),
...
(4, DATE_ADD(CURDATE(), INTERVAL 52 DAY), '16:00:00', 'abierta', 2, 'SalÃ³n Central', 100, 'si', 'si', 'oro');
...
(1, CURDATE(), 'si', 'Reloj de lujo acero y oro con documentaciÃ³n original.', 'https://bidvault.local/docs/reloj-lujo.pdf', 1, 4, 'POL-AR-1001'),
(2, CURDATE(), 'si', 'Obra de arte europea de fines del siglo XIX.', 'https://bidvault.local/docs/obra-europea.pdf', 1, 4, 'POL-AR-1001'),
(3, CURDATE(), 'si', 'Lote de instrumentos musicales de cuerda, viento y percusiÃ³n.', 'https://bidvault.local/docs/instrumentos.pdf', 1, 5, 'POL-US-2001'),
(4, CURDATE(), 'si', 'AutomÃ³vil de colecciÃ³n en excelente estado.', 'https://bidvault.local/docs/automotor.pdf', 1, 5, 'POL-US-2001'),
(5, CURDATE(), 'si', 'ColecciÃ³n de anillos, relojes, pendientes y collares.', 'https://bidvault.local/docs/joyeria-ruiz.pdf', 1, 4, 'POL-AR-1001');
...
(3, 'tarjeta', 'ARS', 'Banco NaciÃ³n', '**** 2044', NULL, 'si', 'si'),
...
(3, 'Producto en camino', 'Tu mueblerÃ­a antigua ya fue despachada. PodÃ©s hacer el seguimiento del envÃ­o.', 'otra');
